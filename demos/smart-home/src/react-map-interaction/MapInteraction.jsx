...
export class MapInteractionControlled extends Component {
  ...
  */
  ...
  translatedOrigin(translation = this.props.value.translation) {
    ...
    return {
      x: clientOffset.left + translation.x + (clientOffset.width * this.VIEWPORT_ORIGIN_X),
      y: clientOffset.top + translation.y + (clientOffset.height * this.VIEWPORT_ORIGIN_Y)
    };
  }

...
// Delete all files which are not exported by the package.
// This is done in order to clean up unnecessary type definition files,
// which are taken care of by api-extractor, which rolls them up into a single file.

// Get the basenames for exported files + sourcemap definitions.
const validFiles = [
  packageJson.main,
...
// Remove all the files which are not in the whitelist.

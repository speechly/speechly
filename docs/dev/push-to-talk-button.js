...
`;
    ...
    class Client {
        constructor(options) {
            ...
            const apiUrl = generateWsUrl((_g = options.apiUrl) !== null && _g !== void 0 ? _g : defaultApiUrl, language, (_h = options.sampleRate) !== null && _h !== void 0 ? _h : microphone.DefaultSampleRate);
            this.apiClient = (_j = options.apiClient) !== null && _j !== void 0 ? _j : new websocket.WebWorkerController(apiUrl);
            this.storage = (_k = options.storage) !== null && _k !== void 0 ? _k : new storage.LocalStorage();
            ...
            if (storedToken == null || !token.validateToken(storedToken, this.projectId, this.appId, this.deviceId)) {
                token.fetchToken(this.loginUrl, this.projectId, this.appId, this.deviceId).then((token) => {
                    this.authToken = token;
            ...
            this.microphone = (_l = options.microphone) !== null && _l !== void 0 ? _l : new microphone.BrowserMicrophone(this.isWebkit, this.sampleRate, this.apiClient);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(mic_fx, file, 237, 2, 7678);
    			add_location(mic_frame, file, 241, 2, 7772);
    			set_custom_element_data(mic_icon, "icon", /*icon*/ ctx[0]);
    			add_location(mic_icon, file, 242, 2, 7787);
    			...
    			add_location(main, file, 221, 0, 7298);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const tangentStart = () => {
    		if (!tangentHeld) {
    			...
    			if (attemptConnect) {
    				...
    				if (client && ready && !listening) (() => __awaiter(void 0, void 0, void 0, function* () {
    	...
    	const tangentEnd = () => {
    		if (tangentHeld) {
    			...
    			// Control speechly
    			if (client && listening) (() => __awaiter(void 0, void 0, void 0, function* () {
    				yield client.stopContext();
    			}))();
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("attemptConnect" in $$props) attemptConnect = $$props.attemptConnect;

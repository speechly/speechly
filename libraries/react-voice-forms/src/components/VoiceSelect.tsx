...
export const VoiceSelect = ({ label, options, displayNames, value, defaultValue, changeOnIntent, changeOnEntityType, changeOnEntityValue, onChange, onFinal, onBlur, onFocus, focused = true }: VoiceSelectProps) => {
